  ...
  return (
    <div className="sticky top-0 right-0 h-[3.5rem] bg-white border-b-gray-200 border flex justify-end max-lg:justify-between items-center px-2 z-10">
      ...
      <div className="relative flex items-center justify-center gap-3">
        ...
        {
          showMenu &&
          <div className="absolute top-10 right-5 grid gap-1 py-2 px-3 rounded-md bg-white shadow-lg">
            <Link to="/" className="py-2 px-4 hover:bg-gray-100 rounded-md flex gap-3 text-sm items-center">
