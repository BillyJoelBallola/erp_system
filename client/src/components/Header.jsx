...
const Header = () => {
  ...
  return (
    <div className="sticky top-0 right-0 h-[4.5rem] bg-white border-b-gray-200 border flex justify-end items-center px-6 z-10">
      <div 
        className="hidden max-lg:grid absolute -left-2 place-items-end bg-gradient-to-r from-cyan-400 to-blue-400 rounded-e-full p-2" 
