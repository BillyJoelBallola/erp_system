        ...
        <>
          ...
          <div className="px-4 py-8 grid gap-6">
            <div className="text-sm mb-6 grid grid-cols-[200px_200px_200px]">
              ...
              <div className="grid gap-2 items-center">
                ...
                <span className={`text-xl bg-gray-200 p-1 px-2 rounded-md max-w-max ${salesInfo.payment === "Pending" ? "text-yellow-500" : "text-blue-400"}`}>
                  {salesInfo.payment}
                </span>
              </div>
              <div className="grid gap-2 items-center">
                ...
                <span className={`text-xl text-blue-400 bg-gray-200 p-1 px-2 rounded-md max-w-max ${salesInfo.payment === "Pending" ? "text-yellow-500" : "text-blue-400"}`}>
                  {salesInfo.shipment}
                </span>
              </div>
            </div>
          <div className="grid grid-cols-[200px_1fr] items-center">
            ...
            <div className="grid grid-cols-[200px_1fr]">
              ...
              <div>
                <div className="grid grid-cols-[1fr_100px_100px_100px_100px_100px] gap-5 py-4 text-gray-500 font-semibold text-sm">
                  <span>ITEM</span>
                  <span>UOM</span>
